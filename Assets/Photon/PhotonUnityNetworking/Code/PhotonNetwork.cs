...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        /// </param>
        public static void LoadLevel(AssetReference levelRef)
        {
            if (PhotonHandler.AppQuits)
            {
                return;
            ...
            {
                SetLevelInPropsIfSynced(levelRef);
            }

            PhotonNetwork.IsMessageQueueRunning = false;
            loadingLevelAndPausedNetwork = true;
            _AsyncLevelLoadingOperation = Addressables.LoadSceneAsync(levelRef);
        }
        ...
        public static void LoadLevel(string levelName)
        {
            ...
            PhotonNetwork.IsMessageQueueRunning = false;
            loadingLevelAndPausedNetwork = true;
            _AsyncLevelLoadingOperation = Addressables.LoadSceneAsync(levelName);
        }
